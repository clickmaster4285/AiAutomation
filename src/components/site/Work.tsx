...
export default function Work() {
  const featured = {
    tag: "Real Estate", title: "300% more qualified leads in 60 days",
    ...
    co: "PropTech Ventures", pipe: "+$2.4M pipeline",
    img: work2,
  };
  const secondary = [
          ...
          {secondary.map((c, i) => (
            ...
            >
              ...
              <div className="absolute inset-0 p-6 flex flex-col justify-between text-white">
                ...
                <div>
                  <h3 className="display text-2xl md:text-3xl mb-4">{c.title}</h3>
