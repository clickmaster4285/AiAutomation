...
export const documentAutomationForManufacturing: SolutionData = {
  ...
  metaDescription:
    'Clickmasters builds Document & Data Automation for manufacturingautomation that reads, validates, and files so your operation saves hours and captures more revenue. Built for how manufacturing actually work.',
  ...
  faqQuestions: [
    {
      ...
      answer:
        'Document and data automation uses OCR and AI to read documents, extract and validate structured data, and route it into business systems automaticallyreplacing manual reading and data entry. For a operation in manufacturing, that means applying it to the workflows that consume your teamsales order entry and confirmation, purchase order creation and tracking, and inventory level monitoring and reorder alertswith the specifics of your industry built in.',
    },
    {
