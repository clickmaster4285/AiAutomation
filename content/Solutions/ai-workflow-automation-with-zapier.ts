// content/Solutions/ai-workflow-automation-with-zapier.ts
import { SolutionData } from '@/content/type';

export const aiWorkflowAutomationWithZapier: SolutionData = {
  slug: 'ai-workflow-automation/with-zapier',
  url: '/solutions/ai-workflow-automation/with-zapier/',
  platform: 'Zapier',
  ...
  processSteps: [
    {
      number: '01',
      title: 'Free Audit',
      description: 'We map your workflow and confirm Zapier is genuinely the right platform for your automation needs.',
    },
    {
      number: '02',
...
export default aiWorkflowAutomationWithZapier;