// content/Solutions/ai-chatbots/for-manufacturing.ts
import { SolutionData } from '@/content/type';

export const aiChatbotsForManufacturing: SolutionData = {
  slug: 'ai-chatbots/for-manufacturing',
  url: '/solutions/ai-chatbots/for-manufacturing/',
  platform: 'AI Chatbots',
  category: 'ai-chatbots',
  title: 'AI Chatbots for Manufacturing',
  primaryKeyword: 'chatbot for manufacturing',
  titleTag: 'AI Chatbots for Manufacturing | Clickmasters',
  metaDescription:
    'Clickmasters builds AI Chatbots for manufacturingautomation that answers, qualifies, and books so your operation saves hours and captures more revenue. Built for how manufacturing actually work.',
...
Every one of these is a workflow problem, not a people problemand workflow problems are what automation eliminates.`,
    ...
    'What We Automate for Manufacturing': `**Grounded Q&A (RAG) for sales order entry and confirmation**answers drawn from your real content, so responses are accurate and on-brand, applied to your operation's sales order entry and confirmation, so this runs consistently instead of depending on whoever has time.
**Lead qualification in conversation for purchase order creation and tracking**visitors engaged, qualified, and captured naturally, applied to your operation's purchase order creation and tracking, so this runs consistently instead of depending on whoever has time.
**Booking and scheduling for inventory level monitoring and reorder alerts**appointments checked and booked directly in chat, applied to your operation's inventory level monitoring and reorder alerts, so this runs consistently instead of depending on whoever has time.
**Action-taking for shipping coordination and tracking updates**lookups, updates, and processes executed, not just described, applied to your operation's shipping coordination and tracking updates, so this runs consistently instead of depending on whoever has time.
**Clean human handoff for production and sales reporting**complex cases escalated with full context attached, applied to your operation's production and sales reporting, so this runs consistently instead of depending on whoever has time.
...
**You own everything.** Documented, transparent systems with no lock-in.`,
  ...
  faqQuestions: [
    {
      question: 'What is chatbot for manufacturing?',
      answer:
        'An AI chatbot uses a language model to understand and respond in natural language, answering from a business\'s own content and taking actions like booking or routingfar beyond old script-based bots. For a operation in manufacturing, that means applying it to the workflows that consume your teamsales order entry and confirmation, purchase order creation and tracking, and inventory level monitoring and reorder alertswith the specifics of your industry built in.',
    },
    {
...
export default aiChatbotsForManufacturing;