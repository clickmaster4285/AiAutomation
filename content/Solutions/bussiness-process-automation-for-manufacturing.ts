...
export const businessProcessAutomationForManufacturing: SolutionData = {
  ...
  metaDescription:
    'Clickmasters builds Business Process Automation for manufacturingautomation that runs, coordinates, and completes so your operation saves hours and captures more revenue. Built for how manufacturing actually work.',
...
What it is: the routine workthe automation that runs, coordinates, and completeshandled automatically, consistently, at any hour, so your operation runs on systems instead of memory and heroics.`,
  ...
  faqQuestions: [
    {
      ...
      answer:
        'Business process automation (BPA) uses software and AI to run an entire business processall its steps, systems, and hand-offsautomatically, rather than automating just one task. For a operation in manufacturing, that means applying it to the workflows that consume your teamsales order entry and confirmation, purchase order creation and tracking, and inventory level monitoring and reorder alertswith the specifics of your industry built in.',
    },
    {
