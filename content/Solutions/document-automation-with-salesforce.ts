// content/Solutions/document-automation-with-salesforce.ts
import { SolutionData } from '@/content/type';

export const documentAutomationWithSalesforce: SolutionData = {
  slug: 'document-automation/with-salesforce',
  url: '/solutions/document-automation/with-salesforce/',
  platform: 'Salesforce',
  ...
  processSteps: [
    {
      number: '01',
      title: 'Free Audit',
      description: 'We map your workflow and confirm Salesforce is genuinely the right platform for your document automation needs.',
    },
    {
      number: '02',
  ...
  stats: [
    { value: '45+', label: 'Document Systems Built' },
  ...
  bestFor: [
    ...
    'Enterprise-grade document processing with security needs',
    'Complex business logic and document workflows',
    'Native Salesforce document integration',
  ],
  considerAlternatives: [
    'Smaller teams without Salesforce expertise',
    'Lightweight document processing without enterprise features',
...
export default documentAutomationWithSalesforce;