// content/Solutions/ai-agents/for-manufacturing.ts
import { SolutionData } from '@/content/type';

export const aiAgentsForManufacturing: SolutionData = {
  slug: 'ai-agents/for-manufacturing',
  url: '/solutions/ai-agents/for-manufacturing/',
  ...
  features: [
    {
      ...
      description: 'Agents built around your specific workflows for order entry.',
    },
    {
      icon: 'Workflow',
      title: 'Multi-Step Task Execution',
      description: 'Agents that plan, act, observe, and adjust for purchase orders.',
    },
    {
      icon: 'Database',
      title: 'RAG Grounding',
      description: 'Decisions based on your real content for inventory monitoring.',
    },
    {
      icon: 'Shield',
      title: 'Guardrails & Human-in-the-Loop',
      description: 'Clear boundaries with escalation for shipping coordination.',
    },
    {
      icon: 'BarChart3',
...
export default aiAgentsForManufacturing;