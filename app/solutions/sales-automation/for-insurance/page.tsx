...
export default function ForInsurancePage() {
  ...
  return (
    <PageWrapper>
      ...
      <HeroSection
        ...
        visual={
          <AutomationHeroMockup
            ...
            submetric="25% increase in policy sales"
            platform="Sales Automation + Insurance Platform"
            accent="#8B5CF6"
          />
        }
        breadcrumb={[
      ...
      <CTASection
        title={content.cta}
        subtitle="Book a free automation audit30 minutes, no obligation, and an honest read on where sales automation pays off for insurance agencies."
        primaryCta={{
