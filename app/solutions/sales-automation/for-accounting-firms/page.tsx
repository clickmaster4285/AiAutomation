...
export default function ForAccountingFirmsPage() {
  ...
  return (
    <PageWrapper>
      ...
      <HeroSection
        ...
        visual={
          <AutomationHeroMockup
            ...
            submetric="40% increase in deal closure rate"
            platform="Sales Automation + Accounting Firms Platform"
            accent="#8B5CF6"
          />
        }
        breadcrumb={[
      ...
      <CTASection
        title={content.cta}
        subtitle="Book a free automation audit30 minutes, no obligation, and an honest read on where sales automation pays off for accounting firms."
        primaryCta={{
