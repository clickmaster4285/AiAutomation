...
export default function SalesAutomationPage() {
  ...
  const platforms = [
    ...
    {
      id: 'salesforce',
      title: 'Salesforce Sales Automation',
      icon: Cloud,
      description: 'Enterprise-grade sales automation on Salesforce — ideal for organizations with Salesforce at the core of revenue operations.',
      href: '/solutions/sales-automation/with-salesforce',
