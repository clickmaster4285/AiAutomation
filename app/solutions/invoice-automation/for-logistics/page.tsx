...
export default function ForLogisticsPage() {
  ...
  return (
    <PageWrapper>
      ...
      <HeroSection
        ...
        visual={
          <AutomationHeroMockup
            ...
            platform="Invoice & Finance Automation + Logistics Management System"
            accent="#F59E0B"
          />
        }
        breadcrumb={[
      ...
      <CTASection
        title={content.cta}
        subtitle="Book a free automation audit30 minutes, no obligation, and an honest read on where finance automation pays off for logistics & transportation."
        primaryCta={{
