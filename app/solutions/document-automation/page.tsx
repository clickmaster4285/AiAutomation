...
export default function DocumentAutomationPage() {
  ...
  const heroData = {
    ...
    subheading:
      'Read, validate, and file documents automaticallybuilt on the platforms you already use.',
    primaryCta: {
  ...
  const platforms = [
    {
      ...
      icon: Database,
      description:
        'Flexible document automation on Airtableperfect for custom operational tools and data workflows without full custom development.',
    ...
    },
    {
      ...
      icon: GitBranch,
      description:
        'Open-source document automation on n8nideal for high-volume, data-sensitive, or AI-heavy production workflows.',
    ...
    },
    {
      ...
      icon: Cloud,
      description:
        'Enterprise-grade document automation on Salesforceideal for organizations with Salesforce at the core of revenue operations.',
  ...
  const features = [
    {
      ...
      description: 'Structured data pulled from PDFs, forms, and imageswithout manual entry.',
      icon: FileText,
    ...
    },
    {
      ...
      description: 'Errors caught before they enter your systemswith human review on exceptions.',
      icon: CheckCircle,
    ...
    },
    {
      ...
      description: 'Information moved between systems without re-keyingreducing errors and hours.',
      icon: Database,
    ...
    },
    {
      ...
      description: 'Routing, approval, and filing automatedso documents go where they need to.',
      icon: GitBranch,
    ...
    },
    {
      ...
      description: 'Data cleaned and transformed at scalebatch processing that handles volume.',
      icon: Cloud,
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-base md:text-lg text-gray-300 mt-4 leading-relaxed max-w-2xl mx-auto">
              We build document automation on the platforms you already usewith honest platform recommendations.
            </p>
          </div>
