...
export default function DocumentAutomationPage() {
  ...
  const heroData = {
    ...
    subheading: 'Read, validate, and file documents automatically  built on the platforms you already use.',
    primaryCta: {
  ...
  const platforms = [
    {
      ...
      icon: Database,
      description: 'Flexible document automation on Airtable  perfect for custom operational tools and data workflows without full custom development.',
    ...
    },
    {
      ...
      icon: GitBranch,
      description: 'Open-source document automation on n8n  ideal for high-volume, data-sensitive, or AI-heavy production workflows.',
    ...
    },
    {
      ...
      icon: Cloud,
      description: 'Enterprise-grade document automation on Salesforce  ideal for organizations with Salesforce at the core of revenue operations.',
