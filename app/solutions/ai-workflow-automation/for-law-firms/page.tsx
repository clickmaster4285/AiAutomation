...
export default function ForLawFirmsPage() {
  ...
  return (
    <PageWrapper>
      ...
      <HeroSection
        ...
        visual={
                                            <AutomationHeroMockup
                                              ...
                                              actionLabels={['Gather Case Information', 'Schedule Consultation', 'Submit Documentation']}
                                              metricValue="3,000"
      ...
      <CTASection
        title={content.cta}
        subtitle="Book a free automation audit30 minutes, no obligation, and an honest read on where workflow automation pays off for law firms."
        primaryCta={{
