...
export default function AIWorkflowAutomationPage() {
  ...
  const heroData = {
    ...
    subheading: 'Multi-step processes that run automatically across your tools — built on the platforms you already use.',
    primaryCta: {
  ...
  const platforms = [
    {
      ...
      icon: Mail,
      description: 'Extend HubSpot\'s power with AI workflows connected to your wider stack — ideal for teams already running sales and marketing on HubSpot.',
    ...
    },
    {
      ...
      icon: Zap,
      description: 'Accessible workflow automation built on Zapier — perfect for straightforward workflows and teams that want to self-serve changes.',
    ...
    },
    {
      ...
      icon: Cloud,
      description: 'Enterprise-grade workflow automation on Salesforce — ideal for organizations with Salesforce at the core of revenue operations.',
    ...
    },
    {
      ...
      icon: GitBranch,
      description: 'Open-source workflow automation on n8n — ideal for high-volume, data-sensitive, or AI-heavy production workflows.',
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-lg md:text-xl text-gray-400 max-w-2xl mx-auto font-light leading-relaxed">
              We build workflow automation on the platforms you already use — with honest platform recommendations.
            </p>
          </div>
