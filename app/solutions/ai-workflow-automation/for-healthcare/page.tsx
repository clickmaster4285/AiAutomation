...
export default function ForHealthcarePage() {
  ...
  return (
    <PageWrapper>
        ...
        secondaryCta={{
         ...
         visual={
                                            <AutomationHeroMockup
                                              ...
                                              actionLabels={['Provide Medical History', 'Schedule Appointment', 'Submit Insurance Information']}
                                              metricValue="3,000"
      ...
      <CTASection
        title={content.cta}
        subtitle="Book a free automation audit30 minutes, no obligation, and an honest read on where workflow automation pays off for healthcare."
        primaryCta={{
