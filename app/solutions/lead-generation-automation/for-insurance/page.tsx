...
export default function ForInsurancePage() {
  ...
  return (
    <PageWrapper>
      ...
      <HeroSection
        ...
        visual={
          <AutomationHeroMockup
            ...
            platform="Lead Generation Automation + Insurance Management System"
            accent="#10B981"
          />
        }
        breadcrumb={[
      ...
      <CTASection
        title={content.cta}
        subtitle="Book a free automation audit30 minutes, no obligation, and an honest read on where lead generation system pays off for insurance agencies."
        primaryCta={{
