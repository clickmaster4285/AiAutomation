...
export default function ForRestaurantsPage() {
  ...
  return (
    <PageWrapper>
      ...
      <HeroSection
        ...
        visual={
          <AutomationHeroMockup
            ...
            platform="Lead Generation Automation + Restaurant Management System"
            accent="#EF4444"
          />
        }
        breadcrumb={[
      ...
      <CTASection
        title={content.cta}
        subtitle="Book a free automation audit30 minutes, no obligation, and an honest read on where lead generation system pays off for restaurants & hospitality."
        primaryCta={{
