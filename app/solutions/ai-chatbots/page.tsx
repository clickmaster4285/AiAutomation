...
export default function AIChatbotsPage() {
  ...
  const heroData = {
    ...
    subheading: 'Intelligent conversations that answer, qualify, and book automatically built on the platforms you already use.',
    primaryCta: {
  ...
  const platforms = [
    {
      ...
      icon: Zap,
      description: 'Accessible chatbots built on Zapier perfect for straightforward workflows and teams that want to self-serve changes.',
    ...
    },
    {
      ...
      icon: Cloud,
      description: 'Enterprise-grade chatbots built on Salesforce ideal for organizations with Salesforce at the core of revenue operations.',
      ...
      <Section bg="dark" pattern="dots" className="py-20">
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <h2 className="display text-3xl md:text-5xl text-white font-bold">
