  ...
  const industries = [
    {
      ...
      icon: Building2,
      description: 'Customer support automation that handles client inquiries, document requests, and status updates.',
      href: '/solutions/customer-support-automation/for-accounting-firms',
      features: ['Client inquiry handling', 'Document requests', 'Status updates'],
    ...
    },
    {
      ...
      title: 'Construction',
      icon: HardHat,
      description: 'Customer support automation that manages bid inquiries, project updates, and client communications.',
      href: '/solutions/customer-support-automation/for-construction',
      features: ['Bid inquiries', 'Project updates', 'Client communication'],
    ...
    },
    {
      ...
      title: 'E-commerce',
      icon: ShoppingBag,
      description: 'Customer support automation that handles order questions, returns, and shipping inquiries.',
      href: '/solutions/customer-support-automation/for-ecommerce',
      features: ['Order questions', 'Returns handling', 'Shipping inquiries'],
    ...
    },
    {
      ...
      title: 'Education',
      icon: GraduationCap,
      description: 'Customer support automation that manages student inquiries, enrollment questions, and FAQs.',
      href: '/solutions/customer-support-automation/for-education',
      features: ['Student inquiries', 'Enrollment questions', 'FAQ handling'],
    ...
    },
    {
      ...
      title: 'Healthcare',
      icon: Heart,
      description: 'Customer support automation that handles appointment questions, patient intake, and billing inquiries.',
      href: '/solutions/customer-support-automation/for-healthcare',
      features: ['Appointment questions', 'Patient intake', 'Billing inquiries'],
    ...
    },
    {
      ...
      icon: Shield,
      description: 'Customer support automation that manages policy questions, claims, and certificate requests.',
      href: '/solutions/customer-support-automation/for-insurance',
      features: ['Policy questions', 'Claims handling', 'Certificate requests'],
    ...
    },
    {
      ...
      title: 'Law Firms',
      icon: Scale,
      description: 'Customer support automation that handles client intake, case questions, and status updates.',
      href: '/solutions/customer-support-automation/for-law-firms',
      features: ['Client intake', 'Case questions', 'Status updates'],
    ...
    // NEW INDUSTRIES
    {
      ...
      icon: Truck,
      description: 'Customer support automation that manages tracking inquiries, delivery updates, and exception alerts.',
      href: '/solutions/customer-support-automation/for-logistics',
      features: ['Tracking inquiries', 'Delivery updates', 'Exception alerts'],
    ...
    },
    {
      ...
      title: 'Manufacturing',
      icon: Factory,
      description: 'Customer support automation that handles order inquiries, production updates, and quality questions.',
      href: '/solutions/customer-support-automation/for-manufacturing',
      features: ['Order inquiries', 'Production updates', 'Quality questions'],
    ...
    },
    {
      ...
      title: 'Real Estate',
      icon: Home,
      description: 'Customer support automation that manages lead inquiries, showing questions, and transaction updates.',
      href: '/solutions/customer-support-automation/for-real-estate',
      features: ['Lead inquiries', 'Showing questions', 'Transaction updates'],
    ...
    },
    {
      ...
      icon: Utensils,
      description: 'Customer support automation that handles reservation questions, feedback, and event inquiries.',
      href: '/solutions/customer-support-automation/for-restaurants',
      features: ['Reservation questions', 'Feedback', 'Event inquiries'],
    ...
    },
    {
      ...
      title: 'Retail',
      icon: Store,
      description: 'Customer support automation that handles product inquiries, order questions, and store information.',
      href: '/solutions/customer-support-automation/for-retail',
      features: ['Product inquiries', 'Order questions', 'Store information'],
    ...
    },
    {
      ...
      icon: Cloud,
      description: 'Customer support automation that handles support tickets, onboarding questions, and feature requests.',
      href: '/solutions/customer-support-automation/for-saas',
      features: ['Support tickets', 'Onboarding questions', 'Feature requests'],
  ...
  return (
    <PageWrapper>
      ...
      <Section bg="black" pattern="dots" className="py-20">
        <div className="container mx-auto px-6">
          ...
          <motion.div
            ...
            className="grid md:grid-cols-1 gap-8 max-w-2xl mx-auto mt-12"
          >
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4 leading-[1.1] tracking-tight">
              Customer Support Automation for Every <span className="text-brand">Industry</span>
            </h2>
            <p className="text-lg md:text-xl text-gray-400 max-w-2xl mx-auto font-light leading-relaxed">
              We build customer support automation designed for the workflows, tools, and constraints of your specific industry.
            </p>
          </div>
      ...
      <FeatureGrid
        ...
        heading="What Our Customer Support Automation Can Do"
        subheading="Every customer support automation we build comes with these core capabilities, tailored to your specific needs."
        features={features}
        columns={3}
        bg="orange-light"
      />
      ...
      <CTASection
        ...
        subtitle="Book a free consultation and let's discuss how AI-powered support automation can improve response times and customer satisfaction."
        primaryCta={{
          text: 'Book a Free Audit',
          href: '/free-automation-audit',
        }}
