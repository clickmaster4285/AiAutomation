...
export default function CustomerSupportAutomationPage() {
  ...
  const heroData = {
    ...
    subheading: 'Resolve, route, and escalate tickets automatically with AI — built on the platforms you already use.',
    primaryCta: {
  ...
  const platforms = [
    {
      ...
      icon: Zap,
      description: 'Accessible support automation built on Zapier — perfect for straightforward workflows and teams that want to self-serve changes.',
