...
export default function ForHealthcarePage() {
  ...
  return (
    <PageWrapper>
      ...
      <HeroSection
        ...
        visual={
          <AutomationHeroMockup
            ...
            actionLabels={['Respond to Inquiry', 'Schedule Appointment', 'Provide Medical Information']}
            metricValue="500"
            metricLabel="new patient inquiries handled automatically each month"
            submetric="85% reduction in administrative workload"
            platform="Customer Support + Electronic Health Record System"
            accent="#EF4444"
          />
        }
        breadcrumb={[
      ...
      <CTASection
        title={content.cta}
        subtitle="Book a free automation audit30 minutes, no obligation, and an honest read on where support automation pays off for healthcare."
        primaryCta={{
