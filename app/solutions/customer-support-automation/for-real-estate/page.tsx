...
export default function ForRealEstatePage() {
  ...
  return (
    <PageWrapper>
      ...
      <HeroSection
        ...
        visual={
          <AutomationHeroMockup
            ...
            triggerLabel="New Property Inquiry"
            actionLabels={['Provide Property Information', 'Schedule Tour', 'Contact Agent']}
            metricValue="1200"
            metricLabel="new property inquiries handled automatically each month"
            submetric="85% reduction in follow-up time"
            platform="Customer Support + Real Estate Management System"
            accent="#10B981"
          />
        }
        breadcrumb={[
      ...
      <CTASection
        title={content.cta}
        subtitle="Book a free automation audit30 minutes, no obligation, and an honest read on where support automation pays off for real estate."
        primaryCta={{
