  ...
  return (
    <PageWrapper>
      ...
      <HeroSection
        ...
        image="/images/solutions/marketing-automation-construction-hero.png"
        imageWidth={700}
        imageHeight={580}
        textSize="xlarge"
        breadcrumb={[
      ...
      <CTASection
        title={content.cta}
        subtitle="Book a free automation audit — 30 minutes, no obligation, and an honest read on where marketing automation pays off for construction."
        primaryCta={{
