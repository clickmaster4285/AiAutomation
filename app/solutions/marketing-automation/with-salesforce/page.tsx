// app/solutions/marketing-automation/with-salesforce/page.tsx
...
import { marketingAutomationWithSalesforce } from '@/content/Solutions';

export const metadata: Metadata = {
  title: marketingAutomationWithSalesforce.titleTag,
  description: marketingAutomationWithSalesforce.metaDescription,
  alternates: {
    canonical: marketingAutomationWithSalesforce.url,
  },
  openGraph: {
    title: marketingAutomationWithSalesforce.titleTag,
    description: marketingAutomationWithSalesforce.metaDescription,
    url: marketingAutomationWithSalesforce.url,
    type: 'website',
  },
  keywords: marketingAutomationWithSalesforce.primaryKeyword,
};

export default function SalesforceMarketingPage() {
  const content = marketingAutomationWithSalesforce;
  ...
  return (
    <PageWrapper>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'Service',
            name: 'AI Marketing Automation with Salesforce',
      ...
      <HeroSection
        ...
        stats={content.stats.slice(0, 3)}
         breadcrumb={[
          ...
          { label: 'With salesforce', href: '/solutions/marketingautomation/with-salesforce' },
        ]}
      />
      ...
      <ContentSection
        id="why-salesforce"
        title="Why Salesforce for AI Marketing Automation"
      
        content={[content.sections['Why Salesforce for AI Marketing Automation']]}
        stats={[
      ...
      <FeatureGrid
        title="What We Build"
        subtitle="Comprehensive marketing automation solutions on Salesforce"
      ...
      <ProcessSteps
        title="How We Work"
        subtitle="Our proven methodology for building marketing automation on Salesforce"
      ...
      <PlatformComparison
        ...
        subtitle="We'll tell you honestly if Salesforce is the right platform for your marketing automation needs."
        bestFor={content.bestFor}
        considerAlternatives={content.considerAlternatives}
      />

      <StatsSection
        title="Why Choose Clickmasters for Salesforce Marketing Automation"
        stats={content.stats}
      />

      <FAQSection
        title="Frequently Asked Questions"
        subtitle="Common questions about marketing automation on Salesforce"
        eyebrow="FAQ"
