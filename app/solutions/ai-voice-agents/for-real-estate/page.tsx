...
export default function ForRealEstatePage() {
  ...
  return (
    <PageWrapper>
      ...
      <HeroSection
        ...
        visual={
                              <AutomationHeroMockup
                                ...
                                actionLabels={['Provide Property Details', 'Schedule Tour', 'Submit Offer']}
                                metricValue="5,000"
                                metricLabel="property inquiries handled automatically this week"
      ...
      <CTASection
        title={content.cta}
        subtitle="Book a free automation audit30 minutes, no obligation, and an honest read on where voice agent pays off for real estate."
        primaryCta={{
