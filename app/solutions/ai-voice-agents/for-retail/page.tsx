// app/solutions/ai-voice-agents/for-retail/page.tsx
...
export const metadata: Metadata = {
  ...
  description: aiVoiceAgentsForRetail.metaDescription,
  alternates: {
    canonical: aiVoiceAgentsForRetail.url,
  },
  openGraph: {
    title: aiVoiceAgentsForRetail.titleTag,
    description: aiVoiceAgentsForRetail.metaDescription,
    url: aiVoiceAgentsForRetail.url,
    type: 'website',
  },
  keywords: aiVoiceAgentsForRetail.primaryKeyword,
};

export default function ForRetailPage() {
  const content = aiVoiceAgentsForRetail;
  ...
  return (
    <PageWrapper>
      ...
      <WhySection
        title="Why Retail Need AI Voice Agents"
        content={[content.sections['Why Retail Need AI Voice Agents']]}
      />
      ...
      <FAQSection
        ...
        subtitle="Common questions about AI voice agents for retail"
