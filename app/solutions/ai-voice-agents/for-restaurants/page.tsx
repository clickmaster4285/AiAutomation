// app/solutions/ai-voice-agents/for-restaurants/page.tsx
...
export const metadata: Metadata = {
  ...
  description: aiVoiceAgentsForRestaurants.metaDescription,
  alternates: {
    canonical: aiVoiceAgentsForRestaurants.url,
  },
  openGraph: {
    title: aiVoiceAgentsForRestaurants.titleTag,
    description: aiVoiceAgentsForRestaurants.metaDescription,
    url: aiVoiceAgentsForRestaurants.url,
    type: 'website',
  },
  keywords: aiVoiceAgentsForRestaurants.primaryKeyword,
};

export default function ForRestaurantsPage() {
  const content = aiVoiceAgentsForRestaurants;
  ...
  return (
    <PageWrapper>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'Service',
            name: 'AI Voice Agents for Restaurants & Hospitality',
      ...
      <WhySection
        title="Why Restaurants & Hospitality Need AI Voice Agents"
        content={[content.sections['Why Restaurants & Hospitality Need AI Voice Agents']]}
      />
      ...
      <FAQSection
        ...
        subtitle="Common questions about AI voice agents for restaurants & hospitality"
