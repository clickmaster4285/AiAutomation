...
export default function ForEcommercePage() {
  ...
  return (
    <PageWrapper>
      ...
      <HeroSection
        ...
        visual={
                              <AutomationHeroMockup
                                ...
                                actionLabels={['Provide Product Information', 'Schedule Demo', 'Send Special Offers']}
                                metricValue="2,000"
      ...
      <CTASection
        title={content.cta}
        subtitle="Book a free automation audit30 minutes, no obligation, and an honest read on where voice agent pays off for e-commerce."
        primaryCta={{
