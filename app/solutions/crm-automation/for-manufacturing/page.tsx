...
export default function ForManufacturingPage() {
  ...
  return (
    <PageWrapper>
      ...
      <HeroSection
        ...
        visual={
          <AutomationHeroMockup
            ...
            submetric="80% increase in sales productivity"
            platform="CRM + Manufacturing Execution System"
            accent="#F59E0B"
          />
        }
        breadcrumb={[
      ...
      <CTASection
        title={content.cta}
        subtitle="Book a free automation audit30 minutes, no obligation, and an honest read on where CRM automation pays off for manufacturing."
        primaryCta={{
