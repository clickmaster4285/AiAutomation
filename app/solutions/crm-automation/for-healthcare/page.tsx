...
export default function ForHealthcarePage() {
  ...
  return (
    <PageWrapper>
      ...
      <HeroSection
        ...
        visual={
          <AutomationHeroMockup
            ...
            actionLabels={['Qualify Lead', 'Send Informational Email', 'Schedule Appointment']}
            metricValue="400"
            metricLabel="new patient inquiries captured automatically each month"
            submetric="80% increase in appointment bookings"
      ...
      <CTASection
        title={content.cta}
        subtitle="Book a free automation audit30 minutes, no obligation, and an honest read on where CRM automation pays off for healthcare."
        primaryCta={{
