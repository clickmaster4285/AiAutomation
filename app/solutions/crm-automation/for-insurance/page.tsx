// app/solutions/crm-automation/for-insurance/page.tsx
...
export const metadata: Metadata = {
  ...
  description: crmAutomationForInsurance.metaDescription,
  alternates: {
    canonical: crmAutomationForInsurance.url,
  },
  openGraph: {
    title: crmAutomationForInsurance.titleTag,
    description: crmAutomationForInsurance.metaDescription,
    url: crmAutomationForInsurance.url,
    type: 'website',
  },
  keywords: crmAutomationForInsurance.primaryKeyword,
};

export default function ForInsurancePage() {
  const content = crmAutomationForInsurance;
  ...
  return (
    <PageWrapper>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'Service',
            name: 'CRM Automation for Insurance Agencies',
      ...
      <WhySection
        title="Why Insurance Agencies Need CRM Automation"
        content={[content.sections['Why Insurance Agencies Need CRM Automation']]}
      />
      ...
      <FAQSection
        ...
        subtitle="Common questions about CRM automation for insurance agencies"
