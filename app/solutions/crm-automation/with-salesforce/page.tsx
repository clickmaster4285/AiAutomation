// app/solutions/crm-automation/with-salesforce/page.tsx
...
import { crmAutomationWithSalesforce } from '@/content/Solutions';

export const metadata: Metadata = {
  title: crmAutomationWithSalesforce.titleTag,
  description: crmAutomationWithSalesforce.metaDescription,
  alternates: {
    canonical: crmAutomationWithSalesforce.url,
  },
  openGraph: {
    title: crmAutomationWithSalesforce.titleTag,
    description: crmAutomationWithSalesforce.metaDescription,
    url: crmAutomationWithSalesforce.url,
    type: 'website',
  },
  keywords: crmAutomationWithSalesforce.primaryKeyword,
};

export default function SalesforceCRMPage() {
  const content = crmAutomationWithSalesforce;
    ...
    <PageWrapper>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'Service',
            name: 'CRM Automation with Salesforce',
      ...
      <HeroSection
        ...
        breadcrumb={[
          ...
          { label: 'With salesforce', href: '/solutions/crm-automation/with-salesforce' },
        ]}
      />
      ...
      <ContentSection
        id="why-salesforce"
        title="Why Salesforce for CRM Automation"
      
        content={[content.sections['Why Salesforce for CRM Automation']]}
        stats={[
      ...
      <FeatureGrid
        title="What We Build"
        subtitle="Comprehensive CRM automation solutions on Salesforce"
      ...
      <ProcessSteps
        title="How We Work"
        subtitle="Our proven methodology for building CRM automation on Salesforce"
      ...
      <PlatformComparison
        ...
        subtitle="We'll tell you honestly if Salesforce is the right platform for your CRM automation needs."
        bestFor={content.bestFor}
        considerAlternatives={content.considerAlternatives}
      />

      <StatsSection
        title="Why Choose Clickmasters for Salesforce CRM Automation"
        stats={content.stats}
      />

      <FAQSection
        title="Frequently Asked Questions"
        subtitle="Common questions about CRM automation on Salesforce"
        eyebrow="FAQ"
