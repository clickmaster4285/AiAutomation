...
export default function ForEducationPage() {
  ...
  return (
    <PageWrapper>
      ...
      <HeroSection
        ...
        visual={
          <AutomationHeroMockup
            ...
            submetric="35% increase in data-driven decision-making"
            platform="Reporting Automation + Educational Platform"
            accent="#3B82F6"
          />
        }
        breadcrumb={[
      ...
      <CTASection
        title={content.cta}
        subtitle="Book a free automation audit30 minutes, no obligation, and an honest read on where reporting automation pays off for education."
        primaryCta={{
