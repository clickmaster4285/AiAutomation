  ...
  return (
    <PageWrapper>
      ...
      <HeroSection
        ...
        image="/images/solutions/reporting-automation-retail-hero.png"
        imageWidth={700}
        imageHeight={580}
        textSize="xlarge"
        breadcrumb={[
      ...
      <CTASection
        title={content.cta}
        subtitle="Book a free automation audit — 30 minutes, no obligation, and an honest read on where reporting automation pays off for retail."
        primaryCta={{
