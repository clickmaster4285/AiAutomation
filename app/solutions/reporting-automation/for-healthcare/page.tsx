// app/solutions/reporting-automation/for-healthcare/page.tsx
...
export const metadata: Metadata = {
  ...
  description: reportingAutomationForHealthcare.metaDescription,
  alternates: {
    canonical: reportingAutomationForHealthcare.url,
  },
  openGraph: {
    title: reportingAutomationForHealthcare.titleTag,
    description: reportingAutomationForHealthcare.metaDescription,
    url: reportingAutomationForHealthcare.url,
    type: 'website',
  },
  keywords: reportingAutomationForHealthcare.primaryKeyword,
};

export default function ForHealthcarePage() {
  const content = reportingAutomationForHealthcare;
  ...
  return (
    <PageWrapper>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'Service',
            name: 'Reporting Automation for Healthcare',
      ...
      <WhySection
        title="Why Healthcare Need Reporting Automation"
        content={[content.sections['Why Healthcare Need Reporting Automation']]}
      />
      ...
      <FAQSection
        ...
        subtitle="Common questions about reporting automation for healthcare"
