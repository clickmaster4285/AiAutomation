// app/solutions/reporting-automation/for-insurance/page.tsx
...
export const metadata: Metadata = {
  ...
  description: reportingAutomationForInsurance.metaDescription,
  alternates: {
    canonical: reportingAutomationForInsurance.url,
  },
  openGraph: {
    title: reportingAutomationForInsurance.titleTag,
    description: reportingAutomationForInsurance.metaDescription,
    url: reportingAutomationForInsurance.url,
    type: 'website',
  },
  keywords: reportingAutomationForInsurance.primaryKeyword,
};

export default function ForInsurancePage() {
  const content = reportingAutomationForInsurance;
  ...
  return (
    <PageWrapper>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'Service',
            name: 'Reporting Automation for Insurance Agencies',
      ...
      <WhySection
        title="Why Insurance Agencies Need Reporting Automation"
        content={[content.sections['Why Insurance Agencies Need Reporting Automation']]}
      />
      ...
      <FAQSection
        ...
        subtitle="Common questions about reporting automation for insurance agencies"
