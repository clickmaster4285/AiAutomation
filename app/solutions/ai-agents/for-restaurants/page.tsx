  ...
  return (
    <PageWrapper>
      ...
      <HeroSection
        ...
        image="/images/ai-agent-restaurants-hero.png"
        imageWidth={700}
        imageHeight={580}
        textSize="xlarge"
        breadcrumb={[
      ...
      <CTASection
        title={content.cta}
        subtitle="Book a free automation audit — 30 minutes, no obligation, and an honest read on where AI agent pays off for restaurants & hospitality."
        primaryCta={{
